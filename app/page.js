...
const Home = () => {
  ...
  return (
    <motion.div 
      className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white px-4 sm:px-6 lg:px-8 font-sans"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.8 }}
    >
      {/* Hero Section */}
      <section className="pt-16 sm:pt-20 pb-24 sm:pb-32 max-w-7xl mx-auto">
        <motion.div 
        ...
        >
          ...
          <motion.h1 
            className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 tracking-tight"
            variants={slideInFromLeft}
            whileHover={{ scale: 1.03, textShadow: "0 0 10px rgba(59, 130, 246, 0.5)" }}
          >
            Tarun Gupta
          </motion.h1>
          
          <motion.p 
            className="text-base sm:text-lg md:text-xl text-gray-200 max-w-3xl leading-relaxed"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.4 }}
          >
            Crafting digital experiences that merge creativity with functionality. 
            Specialized in frontend development with a passion for creating intuitive and impactful web solutions.
          </motion.p>
        </motion.div>
      </section>
      ...
      {/* About Section */}
      <motion.section 
        className="py-16 sm:py-20 bg-gray-900/40 backdrop-blur-sm"
        initial={{ opacity: 0 }}
      ...
      >
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          >
            <Image 
              src="/new.jpg"
              alt="Tarun Gupta's profile picture"
              fill
        ...
        >
          ...
          >
            <motion.a
              ...
              aria-label="Visit Tarun's GitHub profile"
              className="flex items-center space-x-2 px-5 py-3 bg-gray-800 rounded-full hover:bg-gray-700 transition-all text-sm sm:text-base shadow-md"
              whileHover={{ scale: 1.08, boxShadow: "0 0 15px rgba(59, 130, 246, 0.3)" }}
              whileTap={{ scale: 0.95 }}
            >
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit Tarun's LinkedIn profile"
              className="flex items-center space-x-2 px-5 py-3 bg-blue-600 rounded-full hover:bg-blue-700 transition-all text-sm sm:text-base shadow-md"
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="View Tarun's resume"
              className="flex items-center space-x-2 px-5 py-3 bg-purple-600 rounded-full hover:bg-purple-700 transition-all text-sm sm:text-base shadow-md"
              whileHover={{ scale: 1.08 }}
              whileTap={{ scale: 0.95 }}
            >
              <HiDocumentText className="text-lg sm:text-xl" />
              <span>Resume</span>
            </motion.a>
          </motion.div>
        </motion.div>
