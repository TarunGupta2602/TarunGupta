  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <section className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto px-8">
          ...
          >
            ...
            >
              <motion.h1 
                className="text-6xl md:text-8xl font-black bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent"
                animate={{
              ...
              <motion.div
                className="absolute -inset-4 bg-gradient-to-r from-cyan-400/20 to-purple-500/20 rounded-3xl blur-xl"
                animate={{
                  scale: [1, 1.1, 1],
                  opacity: [0.3, 0.6, 0.3]
                }}
            ...
            >
              <Link href="/contact">
                <motion.div
                  className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full font-medium hover:shadow-2xl hover:shadow-cyan-500/25 transition-all cursor-pointer"
              ...
              <motion.a
                ...
                className="px-8 py-4 border border-white/20 rounded-full font-medium hover:bg-white/10 transition-all flex items-center gap-2"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
          ...
          >
            ...
            />
            <motion.div
              className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent rounded-3xl"
              animate={{
                opacity: [0.3, 0.6, 0.3]
              }}
              transition={{ duration: 3, repeat: Infinity }}
        ...
        >
          <div className="text-sm text-gray-400">📍 Ghaziabad, India</div>
          <div className="text-sm text-gray-400">📧 tarun.gupta2606@gmail.com</div>
          <div className="text-sm text-gray-400">📱 +91 7456096455</div>
        </motion.div>
      </section>
      ...
      <section className="py-32 px-8">
        ...
        >
          <motion.h2 
            className="text-6xl font-black text-center mb-20 bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent"
            initial={{ y: 50 }}
            whileInView={{ y: 0 }}
            viewport={{ once: true }}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {skills.map((skill, index) => (
              <motion.div
                key={skill.name}
                className="relative p-6 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:border-white/20 transition-all"
              ...
              >
                <div className="text-xl font-bold mb-4" style={{ color: skill.color }}>
                  {skill.name}
                </div>
      ...
      {/* Projects Section */}
      <section className="py-32 px-8 bg-gradient-to-br from-purple-900/10 to-cyan-900/10">
        <motion.div 
          className="max-w-6xl mx-auto"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        >
          <motion.h2 
            className="text-6xl font-black text-center mb-20 bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent"
            initial={{ y: 50 }}
            whileInView={{ y: 0 }}
            viewport={{ once: true }}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`relative p-8 bg-gradient-to-br ${project.color} rounded-3xl overflow-hidden group cursor-pointer block`}
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
      ...
      <section className="py-32 px-8">
        ...
        >
          <motion.h2 
            className="text-6xl font-black text-center mb-20 bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent"
            initial={{ y: 50 }}
            whileInView={{ y: 0 }}
            viewport={{ once: true }}
          >
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              <motion.div
                key={exp.role}
                className="relative p-8 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 hover:border-white/20 transition-all"
      ...
      {/* Footer */}
      <footer className="py-16 px-8 bg-gradient-to-t from-purple-900/20 to-transparent">
        <motion.div 
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-12">
            {[
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 px-6 py-3 bg-white/10 backdrop-blur-md rounded-full border border-white/20 hover:border-white/40 transition-all"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
