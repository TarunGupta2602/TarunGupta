        ...
        <div>
            <div className="flex flex-col md:flex-row items-center justify-between h-screen p-9 bg-black">
                <div className="flex flex-col w-full md:w-1/2 mb-6 md:mb-0 px-8 md:px-16 lg:px-24">
                    ...
                    <p className="text-white text-2xl font-serif"> <a href="mailto:tarun.gupta2606@gmail.com" className="text-blue-600"> ✉️ tarun.gupta2606@gmail.com</a></p>
                    ...
                    <div className="flex space-x-4 mt-4">
                        ...
                        <a href="mailto:tarun.gupta2606@gmail.com" className="text-gray-600 hover:text-blue-600">✉️</a>
