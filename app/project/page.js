...
const ProjectPage = () => {
  ...
  return (
    <motion.div 
      className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50 text-gray-900 py-16 px-4 sm:px-6 lg:px-8"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="relative bg-white/80 backdrop-blur-md rounded-2xl overflow-hidden border border-gray-100/50"
            >
              <motion.div 
